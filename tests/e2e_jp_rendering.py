...
with sync_playwright() as playwright:
    ...
    # The per-figure visual center correction (canvas alpha scan) legitimately
    # shifts the sprite box vertically; keep the assert within its range.
    assert abs(sprite_box["y"] - expected_top) < 200
